...
from utils.training_utils import pretrain_mae_gan
...
# ====== script settings ======
NUM_EPOCH = 100
bhsz = 28  # 128 (out of memory)
mask_ratio = 0.75
path_save = '../saved_models/maeGAN_pretrain_AdversarialLoss_rt' + str(mask_ratio) + '_E' + str(NUM_EPOCH) + '/'
...
optimizer = torch.optim.AdamW(net.parameters(), lr=1.5e-4, betas=(0.9, 0.95))

net = pretrain_mae_gan(
    train_dataloader,
    optimizer,
    net,
    device,
