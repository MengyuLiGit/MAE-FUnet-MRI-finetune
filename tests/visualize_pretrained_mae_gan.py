...
from nets.mae_gan.models_mae import mae_vit_base_patch16, mae_vit_large_patch16

from utils.help_func import create_path
from utils.data_utils import img_augment
from utils.visualize import run_one_image_mae_gan
...
bhsz = 128
mask_ratio = 0.75
# path_save = '../saved_models/maeGAN_pretrain_MR_brain_rt0.75_E100/model_E5.pt'
# path_save = '../saved_models/maeGAN_pretrain_TwoStage_MR_brain_rt0.75_E100/model_E5.pt'
# path_save = '../saved_models/maeGAN_pretrain_CombinedLoss_MR_brain_rt0.75_E100/model_E100.pt'
path_save = '../saved_models/maeGAN_pretrain_AdversarialLoss_rt0.75_E100/model_E100.pt'
idx_sample = 12
...
tg, recon, img_masked, img_paste = run_one_image_mae_gan(
    test_dataloader,
    idx_sample,
    net,
    device,
