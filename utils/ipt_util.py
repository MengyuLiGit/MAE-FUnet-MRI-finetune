...
### this is the legancy utility file from original IPT trainer
import os
import math
import time
import datetime
...
def make_optimizer(target, lr=1e-4, optimizer='ADAM', weight_decay=0, momentum=0.9, betas=(0.9, 0.999),
                   epsilon=1e-8, decay='200',
                   gamma=0.5, gclip = 0):
    '''
